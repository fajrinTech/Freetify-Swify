...
/// Kontainer navigasi tab utama aplikasi Freetify dengan gesture swipe antar halaman, Sidebar Drawer, Floating Mini Player, dan Floating Glass Tab Bar
public struct MainTabView: View {
    ...
    public var body: some View {
        ...
        ZStack(alignment: .bottom) {
            ...
            // 2. Floating Mini Player & Sleek Glass Tab Bar di Bagian Bawah
            VStack(spacing: 8) {
