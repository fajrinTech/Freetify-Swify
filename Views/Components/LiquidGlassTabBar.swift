...
//  Freetify
//
//  Exact 1-to-1 Native Implementation of UnionTabView (https://github.com/unionst/union-tab-view)
//  Menggunakan API native iOS 26 `.glassEffect(.regular.interactive(), in: .capsule)`
//

import SwiftUI
import UIKit

/// Mesin penggerak seleksi gestur native UISegmentedControl dari UnionTabView
@MainActor
public struct SegmentedControlTabBar: UIViewRepresentable {
    ...
    public func makeUIView(context: Context) -> UISegmentedControl {
        ...
        // Deteksi reselection (ketuk ulang tab aktif)
    ...
    public class Coordinator: NSObject {
        ...
        @MainActor @objc func handleTap(_ gesture: UITapGestureRecognizer) {
            ...
            if index < allCases.count && index == control.selectedSegmentIndex {
                let generator = UIImpactFeedbackGenerator(style: .light)
                generator.impactOccurred()
            }
        }
...
/// Liquid Glass Tab Bar persis 1-to-1 sesuai UnionTabView
